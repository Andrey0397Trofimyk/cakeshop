...
window.Swiper = __webpack_require__(/*! swiper/bundle */ "./node_modules/swiper/swiper-bundle.esm.js");
$(document).ready(function () {
  __webpack_require__(/*! ./layouts/index */ "./resources/js/layouts/index.js");
...
/***/ "./resources/js/layouts/actionIcons.js":
/*!*********************************************!*\
  !*** ./resources/js/layouts/actionIcons.js ***!
  \*********************************************/
/*! no exports provided */
...
$(document).on("click", ".js--trigger-icon", function (event) {
  ...
  var onlineShop = $(".tell__online-shop"),
  ...
  if ($(window).width() > 992) {
    ...
    $(this).siblings().css({
      ...
      height: "calc(100vh - ".concat($(".header").innerHeight(), "px)")
    });
    onlineShop.css({
      margin: "0 auto"
    });
...
$(document).on("click", ".header, .laptop-navbar", function (event) {
  if ($(this).attr("class") !== "laptop-navbar") {
    var mainList = $(".main__list");
    mainList.find(".main__form").fadeOut(250).siblings().removeClass("active");
  }
});

/***/ }),

/***/ "./resources/js/layouts/actionListMain.js":
/*!************************************************!*\
  !*** ./resources/js/layouts/actionListMain.js ***!
  \************************************************/
/*! no exports provided */
...
$(document).on("click", ".js--trigger-main-link", function (event) {
  ...
  var mainForm = $(".main__form"),
      mainNavbar = $(this).siblings().find(".navbar-submenu"),
      mainList = $(".main__list");

  if ($(window).width() > 992) {
    mainForm.css({
      top: "".concat($(".laptop-navbar__signboard").offset().top, "px")
    });
    mainNavbar.css({
...
/***/ "./resources/js/layouts/actionMenuAndSubmenu.js":
/*!******************************************************!*\
  !*** ./resources/js/layouts/actionMenuAndSubmenu.js ***!
  \******************************************************/
/*! no exports provided */
...
$(document).on("click", ".js--trigger-burger", function (event) {
  ...
  headerWrapper.find(".active").removeClass("active").siblings().fadeOut();
  languageList.find(".languages__wrapper").css("margin", 0);
  !$(this).hasClass("active-burger") ? $("body").css("overflow", "hidden") : $("body").css("overflow", "auto");
...
$(document).on("click", ".js--trigger-link-navbar", function (event) {
  event.preventDefault();
  var headerLink = $(".navbar__link");

  if ($(this).hasClass("active-navbar-link")) {
    $(this).toggleClass("active-navbar-link").siblings().slideToggle();
    return false;
  }

  headerLink.not($(this)).removeClass("active-navbar-link").siblings().slideUp();
  $(this).addClass("active-navbar-link").siblings().slideDown();
});
$(document).on("click", ".js--trigger-link-submenu", function (event) {
  event.preventDefault();
  var headerList = $(".navbar__list");
...
$(document).on("click", ".js--show-language", function (event) {
  ...
  language.find(".languages__wrapper").css({
...
$(document).on("click", ".js--dropdown-language", function (event) {
  if ($(event.target).attr("class") == $(this).attr("class")) {
    var formLanguage = $(".header__check-opt");
...
/***/ "./resources/js/layouts/checkInputSearch.js":
/*!**************************************************!*\
  !*** ./resources/js/layouts/checkInputSearch.js ***!
  \**************************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./actionMenuAndSubmenu */ "./resources/js/layouts/actionMenuAndSubmenu.js");

__webpack_require__(/*! ./actionIcons */ "./resources/js/layouts/actionIcons.js");

__webpack_require__(/*! ./checkInputSearch */ "./resources/js/layouts/checkInputSearch.js");

__webpack_require__(/*! ./actionListMain */ "./resources/js/layouts/actionListMain.js");
...
var setOverflowBodyScroll = function setOverflowBodyScroll() {
  ...
  $(window).scrollTop(0); // console.log(scroll);
...
__webpack_require__(/*! ./swiper/swiper */ "./resources/js/pages/swiper/swiper.js"); // require("./swiper/swiper-content");

/***/ }),

/***/ "./resources/js/pages/swiper/swiper.js":
/*!*********************************************!*\
  !*** ./resources/js/pages/swiper/swiper.js ***!
  \*********************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _swiperToLongTerm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./swiperToLongTerm */ "./resources/js/pages/swiper/swiperToLongTerm.js");
...
/***/ "./resources/js/pages/swiper/swiperToLongTerm.js":
/*!*******************************************************!*\
  !*** ./resources/js/pages/swiper/swiperToLongTerm.js ***!
  \*******************************************************/
/*! exports provided: resizeSliderColumn */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "resizeSliderColumn", function() { return resizeSliderColumn; });
var resizeSliderColumn = function resizeSliderColumn() {
  ...
  $(window).resize(function () {
    $(window).width() >= 992 ? slider.addClass("swiper-container-multirow") : slider.removeClass("swiper-container-multirow");

    if ($(window).width() >= 1560) {
      slider.find(".swiper-slide").eq(col - 1).css("margin-top", 0);
    } else if ($(window).width() <= 992) {
...
/***/ "./resources/js/pages/swiper/swiperToSingleTerm.js":
/*!*********************************************************!*\
  !*** ./resources/js/pages/swiper/swiperToSingleTerm.js ***!
  \*********************************************************/
/*! exports provided: resizeSliderRow */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "resizeSliderRow", function() { return resizeSliderRow; });
var resizeSliderRow = function resizeSliderRow() {
  var slider = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
  $(window).resize(function () {
    if ($(window).width() >= 460) {
      slider.find(".swiper-slide").css("margin-top", 0);
...
__webpack_require__(/*! /var/www/cakeshop.com.wm/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /var/www/cakeshop.com.wm/resources/sass/app.scss */"./resources/sass/app.scss");
